...
import Service.manager.ManejadorActaRecepcion.objActaRecepcion;
...
public class ManejadorInstalacionKit {
	...
	public Object[] registrar(HttpServletRequest req,Persona xuser) {
		...
		String FechaInstalación=req.getParameter("fechaInstalación");
		...
		System.out.println("idOrdServ: "+idOrdServ+" idReduc: "+idReduc+" FechaConversion: "+FechaConversion+" FechaInstalación: "+FechaInstalación+" DesintalacionKitGlp: "+DesintalacionKitGlp+" CertificadoDesinstacion: "+CertificadoDesinstacion+" SerieRegulador: "+SerieRegulador+" CertificadoKit: "+CertificadoKit+" SerieMotor: "+SerieMotor);
		...
		try {
			...
			this.db.update(sql,idRegistroKit,idOS,FechaConversion,FechaInstalación,DestKit,CerDes,idR,SerieRegulador,CertificadoKit,SerieMotor,login);
